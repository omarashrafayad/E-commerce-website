...
import { Package, Plus, Search, Filter, Pencil, Trash2, Download, Camera, Loader2 } from "lucide-react";
...
export default function ProductsPage() {
    ...
    const COLUMNS = [
        ...
        { id: "price", header: "Price", cell: (_: unknown, row: Product) => <span className="font-bold">${row.price}</span> },
