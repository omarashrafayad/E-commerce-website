                    ...
                    <div className="w-full max-w-md mx-auto space-y-6">
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 gap-3">
                                ...
                                variant='secondary'
                                    type="button"
                                    className="flex cursor-pointer items-center justify-center h-12 rounded-lg border border-gray-200 hover:bg-gray-50 hover:border-gray-300 transition-all"
                                >
