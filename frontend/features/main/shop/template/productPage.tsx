...
import { useProducts } from "@/features/main/shop/hooks/useProducts";
import SkeletonGrid from "@/components/shared/SkeletonGrid";
import EmptyState from "@/components/ui/EmptyState";
import { SearchX } from "lucide-react";
import { Product } from "@/features/main/shop/types/product.types";
import ShopFilters from "@/features/main/shop/components/ShopFilters";
import MobileFilterSheet from "@/features/main/shop/components/MobileFilterSheet";
            ...
            <>
              ...
              <div className="flex items-center justify-center mt-12 gap-2">
                <button
                  ...
                  className={`p-2 border rounded-md transition-colors ${!pagination?.prev
                ...
                <button
                  ...
                  onClick={() => setPage((p) => p + 1)}
                  className={`p-2 border rounded-md transition-colors ${!pagination?.next
                    ? "opacity-50 cursor-not-allowed"
                    : "hover:bg-accent"
                    }`}
                  aria-label="Next"
