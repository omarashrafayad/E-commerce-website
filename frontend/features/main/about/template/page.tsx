                ...
                <div className="lg:grid lg:grid-cols-2 lg:gap-x-12 lg:items-center">
                    <div>
                        ...
                        <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                            Our mission is to provide an accessible, seamless, and enjoyable shopping experience for everyone. We believe that high-quality products &apos;t come with a high price tag or a complicated checkout process.
                        </p>
