            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
                <div className="mx-auto max-w-2xl text-center mb-16">
                    ...
                    <p className="mt-4 text-lg text-muted-foreground">
                        Have a question or feedback? &apos;d love to hear from you. Fill out the form below or reach out to us directly.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                    <div className="bg-zinc-50 dark:bg-zinc-900 rounded-2xl p-8 border border-border">
                        <form  className="space-y-6">
                            ...
                            <button
                                type="submit"
                                className="flex w-full justify-center rounded-md bg-primary px-3 py-2.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500  focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 items-center gap-2"
                            >
