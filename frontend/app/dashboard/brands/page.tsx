...
import { useBrands, useCreateBrand, useUpdateBrand, useDeleteBrand } from "@/features/main/shop/hooks/useBrands";
...
export default function BrandsPage() {
    ...
    const COLUMNS = [
        ...
        { id: "products", header: "Inventory Stock", accessorKey: "products", className: "text-zinc-600 font-bold" },
        {
            id: "status",
            header: "Visibility",
            cell: (value: any, row: any) => (
        ...
        },
        {
            ...
            cell: (value: any, row: any) => (
                <ActionCell>
                    ...
                    <ActionButton icon={Globe} onClick={() => window.open(row.website, '_blank')} />
                ...
                <DialogContent className="max-w-md rounded-3xl p-0 border-none bg-white dark:bg-zinc-950 shadow-2xl">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="p-8 space-y-6">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="website" className="text-xs font-bold uppercase tracking-widest text-zinc-500 ml-1">Website URL</Label>
                                <Input id="website" {...register("website")} placeholder="https://..." className="h-12 rounded-xl bg-zinc-50 border-none px-4" />
