    ...
    <div className={cn("w-full max-w-[1000px] bg-white rounded-3xl shadow-xl overflow-hidden grid md:grid-cols-2 min-h-[600px]", className)}>
        <div className="hidden md:flex flex-col items-center justify-center bg-[#4F46E5] text-white p-12 relative overflow-hidden">
            ...
            <div className="relative z-10 text-center space-y-6 max-w-sm">
                <h2 className="text-4xl font-bold leading-tight">Adventure start here</h2>
        ...
        <div className="p-8 md:p-12 flex flex-col justify-center bg-white">
            <div className="w-full max-w-md mx-auto space-y-8">
                <div className="text-center md:text-left space-y-2">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900">Hello ! Welcome back</h1>
                </div>

                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" {...props}>
                    ...
                    <div className="grid grid-cols-1 gap-3">
                         <button type="button" className="flex items-center justify-center h-12 rounded-lg border border-gray-200 hover:bg-gray-50 hover:border-gray-300 transition-all">
                    ...
                    <div className="text-center mt-6">
                        <span className="text-gray-500 text-sm">Dont Have an account? </span>
                        <Link href="/register" className="text-blue-600 font-semibold hover:underline text-sm ml-1">
                            Create Account
                        </Link>
                    </div>
                </form>
