...
export default function CouponCard({ code, discount, description, expiryDate, color = "blue" }: CouponCardProps) {
    ...
    // Mapping colors to some button variants or just keeping custom styles but using Button component
    // Since the button has specific colored backgrounds based on prop, we might need to use `className` override or just keep it as custom styled Button
    const btnColors = {
