...
export function SignupForm({
  ...
  return (
    <div className={cn("w-full max-w-[1000px] bg-white rounded-3xl shadow-xl overflow-hidden grid md:grid-cols-2 min-h-[600px]", className)}>
        <div className="hidden md:flex flex-col items-center justify-center bg-[#4F46E5] text-white p-12 relative overflow-hidden">
            ...
            <div className="relative z-10 text-center space-y-6 max-w-sm">
                <h2 className="text-4xl font-bold leading-tight">Join Our Community</h2>
                ...
                <form 
                    ...
                    {/* {errors.root && (
                        <motion.div
                            ...
                            className="p-3 rounded-lg bg-red-50 border border-red-200 flex items-center gap-3 text-red-700 text-sm"
                        >
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input 
                                    ...
                                    className={`pl-10 h-12 bg-gray-50 border-gray-200 focus:bg-white transition-all ${errors.name ? "border-red-500 focus-visible:ring-red-500" : "focus:border-blue-500 focus-visible:ring-blue-500"}`}
                                    {...register("name")}
                                />
                            </div>
                         ...
                         <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input 
                                    ...
                                    className={`pl-10 h-12 bg-gray-50 border-gray-200 focus:bg-white transition-all ${errors.email ? "border-red-500 focus-visible:ring-red-500" : "focus:border-blue-500 focus-visible:ring-blue-500"}`}
                                    {...register("email")}
                                />
                            </div>
                         ...
                         <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input 
                                    ...
                                    placeholder="••••••••"
                                    className={`pl-10 pr-10 h-12 bg-gray-50 border-gray-200 focus:bg-white transition-all ${errors.password ? "border-red-500 focus-visible:ring-red-500" : "focus:border-blue-500 focus-visible:ring-blue-500"}`}
                                    {...register("password")} 
                                />
                                <button
                                    type="button"
                         ...
                         <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input 
                                    ...
                                    placeholder="••••••••"
                                    className={`pl-10 pr-10 h-12 bg-gray-50 border-gray-200 focus:bg-white transition-all ${errors.passwordConfirm ? "border-red-500 focus-visible:ring-red-500" : "focus:border-blue-500 focus-visible:ring-blue-500"}`}
                    ...
                    <div className="grid grid-cols-1 gap-3">
                         <button type="button" className="flex cursor-pointer items-center justify-center h-12 rounded-lg border border-gray-200 hover:bg-gray-50 hover:border-gray-300 transition-all">
                    ...
                    <div className="text-center mt-6">
                        ...
                        <Link href="/login" className="text-blue-600 font-semibold hover:underline text-sm ml-1">
                             Sign in
                        </Link>
                    </div>
                </form>
